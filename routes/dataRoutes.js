...
*           authorizationUrl: http://localhost:8080/api-docs/
*           scopes:
...
router.get('/datax/:id', ensureAuth, dataControllers.findDataById);

//Route update data by id

router.put('/data/:id', ensureAuth, contactValidationRules(), validate, dataControllers.findByIdAndUpdate);

router.get('/dataupdate/:id',  dataControllers.findByIdAndUpdate);
